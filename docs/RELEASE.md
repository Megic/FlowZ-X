...
本文档描述了如何发布 FlowZ-X Electron 的新版本。
...
### Windows
- `FlowZ-X-{version}-win-x64.exe` - NSIS 安装程序
- `FlowZ-X-{version}-win-x64.zip` - 便携版

### macOS
- `FlowZ-X-{version}-mac-x64.dmg` - Intel 芯片 DMG 镜像
- `FlowZ-X-{version}-mac-arm64.dmg` - Apple Silicon DMG 镜像
- `FlowZ-X-{version}-mac-x64.zip` - Intel 芯片便携版
- `FlowZ-X-{version}-mac-arm64.zip` - Apple Silicon 便携版
